...
def main():
    ...
    #scenario_train = ['trace'] # can train on multiple
    scenario_train = ['trace'] # generate embeddings for these
    scenario_test = 'cadets' # generate embeddings for these
    ...
    # construct_examples_supervised([scenario_test], mypath_dir, nodeType_map, edgeType_map)
    ...
    with torch.no_grad():
        ...
        lrprob = logreg.predict_proba(X_test)[:,1]
